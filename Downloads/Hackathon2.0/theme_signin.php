...
<head>
  ...
  <title>Hackathon 2.0||Themes</title>


  <!-- Custom styles for this template -->
  <link href="css_theme/heroic-features.css" rel="stylesheet">
...
<body background="images/BG1.jpg" style="background-repeat: no-repeat;height:100%; background-position: center; background-size: cover;background-attachment: fixed; ">

  <!-- <header id="header">
    <h1 id="logo">
    <a href="./">
      <img style="height:85%" src="images/upes.png">
      <img style="height:80%;padding-left:30px;" src="images/logo.png">
    </a>
  </h1>
    <nav id="nav">
      <ul style="text-transform: uppercase;">
        <li><a onclick="document.getElementById('signin').style.display='block'" style="font-size:17px;color:white;font-family:OCR A Std;font-weight:100;text-decoration:none;" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">Sign-in</a></li>
      </ul>
    </nav>
  </header> -->
